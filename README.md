...
> Estado: prototipo de investigación · v0.8
...
| Fichero | Descripción |
|---|---|
| `ev_trace_md_v08.html` | Herramienta interactiva (EV-TRACE-MD Assistant v0.8) |
...
| `03_plantilla_informe_validacion.md` | Plantilla de informe de validación |
...
- Evaluación asistida por criterio mediante llamadas a la API de Anthropic,
  con consulta de fuentes públicas (políticas de privacidad, ToS, NVD/CVE, trust centers).
...
La carpeta `examples/` contiene dos informes de validación generados con el asistente
...
Los informes de ejemplo en `examples/` mencionan productos y marcas de terceros
